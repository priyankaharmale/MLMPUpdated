...
public class ServiceAppearancesFragment extends Fragment implements View.OnClickListener {

    private String TAG = ServiceAppearancesFragment.class.getSimpleName();
    ...
    public ServiceAppearancesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_service_appearances, container, false);
        initView(view);
        return view;
    }
